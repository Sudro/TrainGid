...
struct qt_meta_stringdata_CLASSCustomSqlTableModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCustomSqlTableModelENDCLASS = QtMocHelpers::stringData(
    "CustomSqlTableModel"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCustomSqlTableModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CustomSqlTableModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCustomSqlTableModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCustomSqlTableModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCustomSqlTableModelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *CustomSqlTableModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCustomSqlTableModelENDCLASS.stringdata0))
