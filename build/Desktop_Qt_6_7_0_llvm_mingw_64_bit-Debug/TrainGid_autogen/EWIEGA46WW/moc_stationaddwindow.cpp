...
void StationAddWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<StationAddWindow *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (StationAddWindow::*)();
            if (_t _q_method = &StationAddWindow::dataChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StationAddWindow::dataChanged()
{
