/********************************************************************************
** Form generated from reading UI file 'trainstationadminwindow.ui'
**
...
#ifndef UI_TRAINSTATIONADMINWINDOW_H
#define UI_TRAINSTATIONADMINWINDOW_H
...
class Ui_TrainStationAdminWindow
{
public:
    QLabel *label;
    ...
    void setupUi(QWidget *TrainStationAdminWindow)
    {
        if (TrainStationAdminWindow->objectName().isEmpty())
            TrainStationAdminWindow->setObjectName("TrainStationAdminWindow");
        TrainStationAdminWindow->resize(982, 628);
        label = new QLabel(TrainStationAdminWindow);
        label->setObjectName("label");
        label->setGeometry(QRect(0, 0, 982, 628));
        label->setPixmap(QPixmap(QString::fromUtf8(":/trainstationFrame.png")));
        pushButton_7 = new QPushButton(TrainStationAdminWindow);
        ...
        pushButton_4 = new QPushButton(TrainStationAdminWindow);
        pushButton_4->setObjectName("pushButton_4");
        pushButton_4->setGeometry(QRect(790, 22, 126, 37));
        pushButton_4->setStyleSheet(QString::fromUtf8("border-radius: 20px; "));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/homeButton2_New.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_4->setIcon(icon6);
        pushButton_4->setIconSize(QSize(126, 37));
        tableView = new QTableView(TrainStationAdminWindow);
...
"}"));
        ...
        pushButton_9 = new QPushButton(TrainStationAdminWindow);
        pushButton_9->setObjectName("pushButton_9");
        pushButton_9->setGeometry(QRect(237, 419, 240, 82));
        pushButton_9->setStyleSheet(QString::fromUtf8("border-radius: 20px; "));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/appendAdminButton_1.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_9->setIcon(icon7);
        pushButton_9->setIconSize(QSize(240, 82));
        pushButton_11 = new QPushButton(TrainStationAdminWindow);
        pushButton_11->setObjectName("pushButton_11");
        pushButton_11->setGeometry(QRect(505, 419, 240, 82));
        ...
        retranslateUi(TrainStationAdminWindow);

        QMetaObject::connectSlotsByName(TrainStationAdminWindow);
    } // setupUi

    void retranslateUi(QWidget *TrainStationAdminWindow)
    {
        TrainStationAdminWindow->setWindowTitle(QCoreApplication::translate("TrainStationAdminWindow", "Form", nullptr));
...
namespace Ui {
    class TrainStationAdminWindow: public Ui_TrainStationAdminWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TRAINSTATIONADMINWINDOW_H
