...
public:
    ...
    void setupUi(QWidget *RouteAdminWindow)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/tariffsButton2.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/stationsButton2.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        pushButton_6 = new QPushButton(RouteAdminWindow);
