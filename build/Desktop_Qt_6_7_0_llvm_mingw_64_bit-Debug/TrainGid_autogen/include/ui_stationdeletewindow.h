/********************************************************************************
** Form generated from reading UI file 'stationdeletewindow.ui'
**
...
#ifndef UI_STATIONDELETEWINDOW_H
#define UI_STATIONDELETEWINDOW_H
...
public:
    ...
    void setupUi(QWidget *StationDeleteWindow)
    {
        if (StationDeleteWindow->objectName().isEmpty())
            StationDeleteWindow->setObjectName("StationDeleteWindow");
        StationDeleteWindow->resize(982, 628);
        label = new QLabel(StationDeleteWindow);
        label->setObjectName("label");
        label->setGeometry(QRect(0, 0, 982, 628));
        label->setPixmap(QPixmap(QString::fromUtf8(":/deleteWindow.png")));
        lineEdit_2 = new QLineEdit(StationDeleteWindow);
...
""
                        "}"));
        pushButton_3 = new QPushButton(StationDeleteWindow);
        ...
        pushButton_11 = new QPushButton(StationDeleteWindow);
        ...
        pushButton_2 = new QPushButton(StationDeleteWindow);
        ...
        retranslateUi(StationDeleteWindow);

        QMetaObject::connectSlotsByName(StationDeleteWindow);
    } // setupUi

    void retranslateUi(QWidget *StationDeleteWindow)
    {
        StationDeleteWindow->setWindowTitle(QCoreApplication::translate("StationDeleteWindow", "Form", nullptr));
...
namespace Ui {
    class StationDeleteWindow: public Ui_StationDeleteWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_STATIONDELETEWINDOW_H
