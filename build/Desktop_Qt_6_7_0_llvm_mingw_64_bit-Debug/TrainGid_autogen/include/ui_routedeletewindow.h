/********************************************************************************
** Form generated from reading UI file 'routedeletewindow.ui'
**
...
#ifndef UI_ROUTEDELETEWINDOW_H
#define UI_ROUTEDELETEWINDOW_H
...
public:
    ...
    void setupUi(QWidget *RouteDeleteWindow)
    {
        if (RouteDeleteWindow->objectName().isEmpty())
            RouteDeleteWindow->setObjectName("RouteDeleteWindow");
        RouteDeleteWindow->resize(982, 628);
        label = new QLabel(RouteDeleteWindow);
        label->setObjectName("label");
        label->setGeometry(QRect(0, 0, 982, 628));
        label->setPixmap(QPixmap(QString::fromUtf8(":/deleteWindow.png")));
        pushButton_2 = new QPushButton(RouteDeleteWindow);
        ...
        lineEdit_2 = new QLineEdit(RouteDeleteWindow);
        lineEdit_2->setObjectName("lineEdit_2");
        lineEdit_2->setGeometry(QRect(43, 164, 895, 66));
...
""
                        "}"));
        pushButton_3 = new QPushButton(RouteDeleteWindow);
        ...
        pushButton_11 = new QPushButton(RouteDeleteWindow);
        ...
        lineEdit_3 = new QLineEdit(RouteDeleteWindow);
        lineEdit_3->setObjectName("lineEdit_3");
        lineEdit_3->setGeometry(QRect(43, 256, 895, 66));
...
""
        ...
        retranslateUi(RouteDeleteWindow);

        QMetaObject::connectSlotsByName(RouteDeleteWindow);
    } // setupUi

    void retranslateUi(QWidget *RouteDeleteWindow)
    {
        RouteDeleteWindow->setWindowTitle(QCoreApplication::translate("RouteDeleteWindow", "Form", nullptr));
...
namespace Ui {
    class RouteDeleteWindow: public Ui_RouteDeleteWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ROUTEDELETEWINDOW_H
