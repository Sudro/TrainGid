/********************************************************************************
** Form generated from reading UI file 'tariffadminwindow.ui'
**
...
#ifndef UI_TARIFFADMINWINDOW_H
#define UI_TARIFFADMINWINDOW_H
...
public:
    ...
    void setupUi(QWidget *TariffAdminWindow)
    {
        if (TariffAdminWindow->objectName().isEmpty())
            TariffAdminWindow->setObjectName("TariffAdminWindow");
        TariffAdminWindow->resize(982, 628);
        label = new QLabel(TariffAdminWindow);
        label->setObjectName("label");
        label->setGeometry(QRect(0, 0, 982, 628));
        label->setPixmap(QPixmap(QString::fromUtf8(":/tariffFrame.png")));
        pushButton_3 = new QPushButton(TariffAdminWindow);
        ...
        pushButton_2 = new QPushButton(TariffAdminWindow);
        ...
        pushButton_5 = new QPushButton(TariffAdminWindow);
        pushButton_5->setObjectName("pushButton_5");
        pushButton_5->setGeometry(QRect(701, 22, 106, 37));
        pushButton_5->setStyleSheet(QString::fromUtf8("border-radius: 20px; "));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/trainButton2.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_5->setIcon(icon4);
        pushButton_5->setIconSize(QSize(106, 37));
        pushButton_6 = new QPushButton(TariffAdminWindow);
        ...
        pushButton_9 = new QPushButton(TariffAdminWindow);
        pushButton_9->setObjectName("pushButton_9");
        pushButton_9->setGeometry(QRect(119, 419, 240, 82));
        pushButton_9->setStyleSheet(QString::fromUtf8("border-radius: 20px; "));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/appendAdminButton.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_9->setIcon(icon9);
        pushButton_9->setIconSize(QSize(240, 82));

        retranslateUi(TariffAdminWindow);

        QMetaObject::connectSlotsByName(TariffAdminWindow);
    } // setupUi

    void retranslateUi(QWidget *TariffAdminWindow)
    {
        TariffAdminWindow->setWindowTitle(QCoreApplication::translate("TariffAdminWindow", "Form", nullptr));
...
namespace Ui {
    class TariffAdminWindow: public Ui_TariffAdminWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TARIFFADMINWINDOW_H
